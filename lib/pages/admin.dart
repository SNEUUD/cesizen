...
Future<List<UserAdmin>> fetchUsers() async {
  final response = await http.get(Uri.parse('http://192.168.1.253:3050/users'));
...
Future<void> deleteUser(String id, BuildContext context) async {
  final response = await http.delete(
    Uri.parse('http://192.168.1.253:3050/users/$id'),
  );
  if (response.statusCode == 200) {
...
Future<void> toggleUserStatus(
  ...
  final response = await http.put(
    Uri.parse('http://192.168.1.253:3050/users/$id/status'),
